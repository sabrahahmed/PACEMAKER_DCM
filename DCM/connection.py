...
# CLASS FOR SERIAL COMMUNICATION / CONNECTION
class Connect:
...
# connect = Connect("COM6")
# mode=connect.rqst_para("Marcus")

# count=0
# while count<100:
#     count+=1
#     #sleep(0.0005)
#     volts = connect.rqst_egram()
#     #volts = connect.egram_data()
#     print('atrial:'+str(volts[0]))
#     print('vent:'+str(volts[1]))
